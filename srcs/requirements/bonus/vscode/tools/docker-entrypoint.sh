...
exec code-server --auth=password --bind-addr=0.0.0.0:8443 --user-data-dir=/var/www/html --cert=/etc/ssl/certs/vscode-selfsigned.crt --cert-key=/etc/ssl/private/vscode-selfsigned.key
